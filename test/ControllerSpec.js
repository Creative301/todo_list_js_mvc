...
describe('controller', function () {
	...
	var createViewStub = function () {
		var eventRegistry = {};
		return {
			render: jasmine.createSpy('render'), // view.js line 95
	...
	beforeEach(function () {
		...
		view = createViewStub();
		subject = new app.Controller(model, view); // controller.js line 11 
	});
	...
	describe('routing', function () {
		...
		it('should show all entries without a route', function () {
			...
			subject.setView(''); // setView: controller.js: 54
			// render: view.js:95, showEntries: view.js: 98
	...
	it('should check the toggle all button, if all todos are completed', function () {
		...
		subject.setView('');
		// clearCompletedButton = view.js: 113
	...
	it('should set the "clear completed" button', function () {
		...
		subject.setView('');
		// clearCompletedButton = view.js: 107
